...
A hack day is a focused, collaborative working session centered around building and improving a shared resource. In our case, that means developing assignments for [AstroCodEx](https://astrocodex.github.io), an open-source repository of interactive programming exercises written in Jupyter notebooks with MyST Markdown.
...
Please register by **Tuesday, August 19** using this [registration form](https://forms.gle/D198Dt47aFNyNcRR6). 
