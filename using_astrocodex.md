...
The astrocodex is organized as a jupyter-book built with myst tools. This allows for 
...
and modified to suit teaching needs. Users agree not to use downloaded 
materials for commercial purposes. Credit should be given to the AstroCodEx Collaboration 
and authors if materials are used in a public format (outside of a classroom setting), 
including modified versions of the activities. We request that users withhold from 
uploading AstroCodEx materials into AI tools. 

Solutions to individual exercises in the repository may be granted upon request, and 
...
The astrocodex is open-source, and we encourage contributions. If you have an exercise that you think would fit well into the codex, you may submit it through the [AstroCodEx Submission and Modification Form](https://forms.gle/opX77Hi937kA5wgh9). All submissions should be formatted with the [provided template](_templates/submission_template.ipynb), which will ensure proper rendering and formatting on the website using MyST Markdown. 
...
The [AstroCodEx Team](aboutteam.md) includes maintainers who are responsible for maintenance of the AstroCodEx page and submissions. Maintainers will update the AstroCodEx website for readability and accessibility. Given that Python packages may lose compatibility with newer versions, maintainers will periodically verify that assignments can still be completed using the provided requirements.txt files. Minor adjustments may be made automatically by the maintainers for the purpose of supporting version compatibility over time. If major adjustments are necessary, maintainers will reach out to the assignment author(s) to make changes. To modify your assignment yourself, see the [AstroCodEx Submission and Modification Form](https://forms.gle/opX77Hi937kA5wgh9). Maintainers will review and update modified assignments within 2-4 weeks. 
